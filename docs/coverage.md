...
| Japan invoice rounding | [NTA: rounding calculations, No. 6371](https://www.nta.go.jp/taxes/shiraberu/taxanswer/shohi/6371.htm) | Aggregate by rate within a qualified invoice and round once per rate. The arithmetic API expects callers to perform that grouping. |
